...
class SelfAttention(tf.keras.Model):
    ...
    def call(self, input_):
        ...
        if self.sa_type == 0:
            ...
            w = tf.reshape(out, [64, -1, pow(self.kernel_size, 2), x1.shape[-1]])
